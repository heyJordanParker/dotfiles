...
alias cld="USER_TYPE=ant CLAUDE_CODE_NO_FLICKER=1 CLAUDE_CODE_ENABLE_TASKS=true EDITOR=prompt-editor claude --dangerously-skip-permissions --teammate-mode in-process --agent cto --model fable --effort medium --autocompact 700k"
alias cldcopy="USER_TYPE=ant CLAUDE_CODE_NO_FLICKER=1 CLAUDE_CODE_ENABLE_TASKS=true EDITOR=prompt-editor CLAUDE_CONFIG_DIR=$HOME/.claude/profiles/copywriter claude --dangerously-skip-permissions --teammate-mode in-process --mcp-config $HOME/.claude/profiles/copywriter/.mcp.json --strict-mcp-config --agent copy-chief --model fable --effort medium --autocompact 700k"
