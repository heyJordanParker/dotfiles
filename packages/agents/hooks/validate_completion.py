...
def _eval_prompt(plan_context, session_context, recent_user_msgs, last_msg,
    ...
    return (
        ...
        '   Exception: stating that the cause is not yet known is honest — "I have not yet determined what broke this" is allowed. Blaming the baseline to justify stopping is not.\n\n'
