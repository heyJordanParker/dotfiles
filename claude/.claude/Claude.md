...
|----|------|---|-------|------|
| #24 | 3:09 PM | 🔵 | Claude.md defines persona, principles, and architectural decision framework | ~545 |
| #23 | " | 🔵 | Claude settings.json configures permissions, hooks, and model preferences | ~443 |
</claude-mem-context>