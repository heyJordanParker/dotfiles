---
description: Answer questions only — no actions, no sycophancy, just well-reasoned analysis.
---
...
- If you're uncertain: research first, understand the code & then answer.
