...
4. **Clarify gaps early** - Edge cases, error handling, scope boundaries before architecture
5. **One at a time** - Don't batch questions
6. **Use naming skill** - All identifiers in examples must follow naming conventions
