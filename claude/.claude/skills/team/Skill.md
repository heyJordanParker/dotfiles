---
name: team
description: Framework for creating and coordinating persistent teams. Teams persist across slices and turns — teammates accept new work via SendMessage. Covers team lifecycle, dispatch patterns, and prompting (WHAT/WHY, never HOW). For one-shot agents, use /subagents.
---
